...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="configs/config/vgg_ssd300_voc0712.yaml",
        metavar="FILE",
    ...
    parser.add_argument("--output_dir", default="demo/eval_results", type=str, help="The directory to store evaluation results.")
